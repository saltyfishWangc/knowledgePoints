...
//        String FILE_PATH = "/upload/53/out";
        ...
        try {
            ...
            System.out.println("密钥地址：" + SftpTest2.class.getClassLoader().getResource("msok").getPath());
            sftp = ZYSFTPUtils.getChannel(SftpTest2.class.getClassLoader().getResource("msok").getPath(), ZYXJ_FTP_USER, Integer.valueOf(ZYXJ_FTP_PORT), ZYXJ_FTP_HOST);
